...
<body>
	...
	<section class="page-info-section">
		<div class="container">
			...
			<div class="site-beradcamb">
				<a href="">Home</a>
				<span><i class="fa fa-angle-right"></i> Reset Password > Code Validation > Enter New Password</span>
			</div>
		</div>
	</section>
	<!-- Page info end -->
	...
	<form method="POST" action="./db_class/dbClass.php">
		...
		<div class="inputGroup inputGroup2">
			<label for="resetnow_newpassword">New Password</label>
			<input type="password" id="password" name="resetnow_newpassword" class="resetnow_newpassword" maxlength="256"/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="resetnow_newpasswordconf">Confirm Password</label>
			<input type="password" id="password" name="resetnow_newpasswordconf" class="resetnow_newpasswordconf" maxlength="256"/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup3">
			<button id="login" name="resetnow_button">Proceed</button>
		</div>	
		<br><br>
