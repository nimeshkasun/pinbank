<?php
	...
	$mail->Subject = 'Call Me Request ['.$accountNumber.'] | Pin Online Banking';
	...
	$body .= "<td style='border:none;'><strong>Customer account holding: {$accountNumber} has requested call back support. Proceed with the request immediately.</strong><br><br></td></td>";
	$body .= "<tr><td style='border:none;'>Customer Number:<strong> <div style='width: 200px; padding: 5px; border: 2px solid red; text-align: center;'><a href='tel:{$passedNumber}'>{$passedNumber}</a></div></strong><br><br><br></td>";
	$body .= "</tr>";
