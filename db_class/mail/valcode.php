<?php
	...
	$mail->Subject = 'Password Reset Request | Pin Online Banking';
	...
	$body .= "<tr><td style='border:none;'>Validation Code:<strong> <div style='width: 100px; padding: 5px; border: 2px solid red; text-align: center;'>{$valcode}</div></strong><br><br><br></td>";
	$body .= "</tr>";
