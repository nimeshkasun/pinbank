                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $_SESSION['emailsavedCust']; ?></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php 
                                                                    if($userTypesavedCust == "custAdv"){
                                                                        echo "Advanced Mode";
                                                                    }elseif ($userTypesavedCust == "custMed") {
                                                                        echo "Medium Mode";
                                                                    }elseif ($userTypesavedCust == "custEas") {
                                                                        echo "Easy Mode";
                                                                    }elseif ($userTypesavedCust == "staAdmin") {
                                                                        echo "Admin Mode";
                                                                    }elseif ($userTypesavedCust == "staLocal") {
                                                                        echo "Staff Mode";
                                                                    }elseif ($userTypesavedCust == "staSupp") {
                                                                        echo "Support Mode";
                                                                    }  
                                                                ?></td>
                                                            </tr>
                                ...
                                <div class="col-lg-12">
                                    <div class="general-info">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <select type="select" name="userMode" style="width: 100%;" required>
                                                                        ...
                                                                        <option style="background-color: red; color: white;" value="staSupp">Support Mode</option>
                                                                        <option style="background-color: red; color: white;" value="staLocal">Staff Mode</option>
                                                                        <option style="background-color: red; color: white;" value="staAdmin">Admin Mode</option>
                                                                    </select>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="text-center">
                                        	<button type="submit" name="saveCust" class="btn btn-primary waves-effect waves-light m-r-20">Save</button>
