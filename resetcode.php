...
<body>
	...
	<section class="page-info-section">
		<div class="container">
			...
			<div class="site-beradcamb">
				<a href="">Home</a>
				<span><i class="fa fa-angle-right"></i> Reset Password > Code Validation</span>
			</div>
		</div>
	</section>
	<!-- Page info end -->
	...
	<form method="POST" action="./db_class/dbClass.php">
		...
		<div class="inputGroup inputGroup1">
			<label for="codevalidation_code">Validation Code</label>
			<input type="number" id="code" name="codevalidation_code" class="email" maxlength="256"/>
			<p class="helper helper1"><b>p-<b></p>
				<span class="indicator"></span>
			</div><br><br>
			<div class="inputGroup inputGroup3">
				<button id="login" name="codevalidation_button">Validate Code</button>
			</div>	
			<br><br>
