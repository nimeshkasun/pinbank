...
$mail->Subject = 'Password Reset Success | Pin Online Banking';
	...
	$body .= "<td style='border:none;'><strong>You account password has been reset on Pin Online Banking. If you did not request the service, immediately contact the bank support.</strong><br><br></td></td>";
