	...
	<form method="POST" action="./db_class/dbClass.php">
		...
		if(isset($_GET['c'])){
			if($_GET['c']=="1"){
				...
				<span class='closebtn'>&times;</span>  
				<strong>Alert!</strong> Your account is either inactive or temoporarily blocked. Please contact the bank.
				</div>";
			}
		}
		?>
		...
		<div class="inputGroup inputGroup1">
			...
			<input type="email" id="email" name="signin_email" class="email" maxlength="256"/>
			<p class="helper helper1">email@domain.com</p>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="password">Password</label>
			<input type="password" id="password" name="signin_password" class="password" />
		</div>
