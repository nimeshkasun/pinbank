...
<body>
	...
	<form method="POST" action="./db_class/dbClass.php">
		...
		<div class="inputGroup inputGroup2">
			...
			<input type="text" id="fname" name="signup_firstname" class="fname" maxlength="256" required />
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="lname">Last Name</label>
			<input type="text" id="lname" name="signup_lastname" class="lname" maxlength="256" required/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup1">
			<label for="email1">Email</label>
			<input type="email" id="email" name="signup_email" class="email" maxlength="256" .<?php if(isset($_POST['homePageRequest'])){ ?>. value="<?php $emailPassed = $_POST['homePageSignUp']; echo $emailPassed; ?>".<?php } ?>. required/>
			<p class="helper helper1">email@domain.com</p>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="password">Password</label>
			<input type="password" id="password" name="signup_password" class="password"  required/>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="confirmpassword">Confirm Password</label>
			<input type="password" id="password" name="signup_passwordconfirm" class="password" required />
		</div>
		<div class="inputGroup inputGroup2">
			<label for="lname">Phone Number</label>
			<input type="number" id="phone" name="signup_phonenumber" class="lname" maxlength="20" required/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="staddress">PO Box/ Street Address</label>
			<input type="text" id="staddress" name="signup_staddress" class="staddress" maxlength="256"/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="addline1">Address Line 1</label>
			<input type="text" id="addline1" name="signup_addline1" class="addline1" maxlength="256" required/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="addline2">Address Line 2</label>
			<input type="text" id="addline2" name="signup_addline2" class="addline2" maxlength="256"/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="city">City</label>
			<input type="text" id="city" name="signup_city" class="city" maxlength="256" required/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="stateprovince">State/ Province</label>
			<input type="text" id="stateprovince" name="signup_stateprovince" class="stateprovince" maxlength="256" required/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
			<label for="postalcode">Postal Code</label>
			<input type="text" id="postalcode" name="signup_postalcode" class="postalcode" maxlength="20" required/>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup2">
	...
	<script  src="./js/scriptloginreg.js"></script>
