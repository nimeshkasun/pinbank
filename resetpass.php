...
<body>
	...
	<section class="page-info-section">
		<div class="container">
			...
			<div class="site-beradcamb">
				<a href="">Home</a>
				<span><i class="fa fa-angle-right"></i> Reset Password</span>
			</div>
		</div>
	</section>
	<!-- Page info end -->
	...
	<form method="POST" action="./db_class/dbClass.php">
		...
		<div class="inputGroup inputGroup1">
			...
			<input type="email" id="email" name="resetpass_email" class="email" maxlength="256"/>
			<p class="helper helper1">email@domain.com</p>
			<span class="indicator"></span>
		</div>
		<div class="inputGroup inputGroup3">
			<button id="login" name="resetpass_button">Reset Password</button>
		</div>	
		<br><br>
