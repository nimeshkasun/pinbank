...
<?php if($vCardName3!=NULL){ ?>
<div class="card social-card text-white bg-c-yellow">
    <div class="card-block">
    	<div class="row align-items-center">
			<div class="col">
		        <h6 class="m-b-0">Virtual Card: <?php echo $vCardName3; ?></h6>
		        <h4 class="m-t-10 m-b-10"><?php echo $aCurrency; ?> <?php echo $vCardBalance3; ?></h4>
		        <p class="m-b-0"><?php echo $vCardNumber3." ".$vExpireDate3." ".$vCSV3; ?></p>
		    </div>
		</div>
    </div>
    <a href="./dbClass.php?delVc=<?php echo $vCardNumber3; ?>" class="download-icon"><i class="ti-trash"></i></a>
</div>
<?php } ?>