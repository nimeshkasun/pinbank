    <title>Dashboard | Pin - Online Banking System</title>
    <meta charset="utf-8">
    ...
    <!-- Helps in automatic retrival -->
    <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script> -->
        <script src="./files/assets/jquery.min.js"></script>
        <script src="./files/assets/bootstrap.min.js"></script>
        <!-- Data Table Css -->
        ...
        <!-- Charts Custom Css -->
        <link rel="stylesheet" type="text/css" href="./files/assets/chart_JsCss/homeSendReceiveChart.css">
